...
const EventForm = ({ isOpen, onClose, setRefresh }) => {
    ...
    const minuteLength = minutes ? String(minutes).length : 0;
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <h2 className="text-xl font-semibold mb-4 border-b-2 border-gray-100 pb-5">Create Event</h2>
                    ...
                    <div className="flex-1 mt-1 min-w-[150px]">
                        ...
                        <div className="flex justify-center items-center bg-[#f7f7f7] border-gray-500 border rounded-md relative flex-grow">
                            ...
                            <div className="relative">
                                ...
                                />{minutes && <span className="absolute top-0" style={{ left: `${minuteLength * 9 + 10}px` }}>m</span>}
                            </div>
                        </div>
                    </div>
                </div>
