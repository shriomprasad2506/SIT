...
const DeleteModal = ({ isOpen, onClose, eventId, eventName, setRefresh }) => {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (response.status === 200) {
                console.log(`Deleted event ${eventName} with ID: ${eventId}`);
                // You can trigger a state update or refresh the events list here if needed
                setRefresh(true)
